...
public class ZuoraController {
	//
	//holds the username to connect to the Zuora service
	static String apiAccessKeyId = "ENTER USER NAME";
	//holds the password to connect to the Zuora service
	static String apiSecretAccessKey = "ENTER PASSWORD";
	...
	public static void main(String[] args) {
		try{
			...
			apiClient.addDefaultHeader("apiAccessKeyId",apiAccessKeyId);
			apiClient.addDefaultHeader("apiSecretAccessKey", apiSecretAccessKey);
	...
	public static String upgradeSubscription(ApiClient apiClient, String subscriptionId, String ratePlanToAdd) throws ApiException
	{
		...
		System.out.println("Subscription upgrade status:"+response.getSuccess()+" and generated ID:"+response.subscriptionId(subscriptionId));
